  ...
  const categories = [
    {
      ...
      search: "computer science programming software",
    },
    {
      name: "Mathematics",
      slug: "mathematics",
      search: "mathematics calculus algebra statistics",
    },
    {
      name: "Physics",
      slug: "physics",
      search: "physics quantum mechanics thermodynamics",
    },
    {
      name: "Chemistry",
      slug: "chemistry",
      search: "chemistry organic inorganic biochemistry",
    },
    {
      name: "Biology",
      slug: "biology",
      search: "biology molecular genetics microbiology",
    },
    {
      name: "Psychology",
      slug: "psychology",
      search: "psychology cognitive behavioral developmental",
    },
    {
      name: "History",
      slug: "history",
      search: "history world ancient modern civilization",
    },
    {
      name: "Literature",
      slug: "literature",
      search: "literature english classics poetry",
    },
    {
      name: "Economics",
      slug: "economics",
      search: "economics microeconomics macroeconomics finance",
    },
    {
      name: "Engineering",
      slug: "engineering",
      search: "engineering mechanical electrical civil",
    },
    {
      name: "Business",
      slug: "business",
      search: "business management finance accounting",
    },
    {
      name: "Philosophy",
      slug: "philosophy",
      search: "philosophy ethics logic metaphysics",
    },
  ];
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <span className="text-xs sm:text-sm text-gray-500 block leading-none font-medium">
                      Academic
                    </span>
                  </div>
                </div>
                        ...
                        <span className="flex items-center">
                          ...
                          >
                            <path
                              ...
                              strokeLinejoin="round"
                              strokeWidth={2}
                              d="M12 10v6m0 0l-4-4m4 4l4-4m-6-6V4"
                            />
                          </svg>
                          Downloads
                        </span>
