...
const HomePage = () => {
  ...
  const [categories] = useState([
    ...
    { name: 'History', count: 723, icon: '🏛️', color: 'from-yellow-500 to-orange-600' },
    { name: 'Literature', count: 934, icon: '📖', color: 'from-pink-500 to-rose-600' },
    { name: 'Economics', count: 445, icon: '📊', color: 'from-teal-500 to-green-600' },
    { name: 'Engineering', count: 567, icon: '⚙️', color: 'from-gray-500 to-slate-600' },
    { name: 'Business', count: 389, icon: '💼', color: 'from-cyan-500 to-blue-600' },
    { name: 'Philosophy', count: 298, icon: '🤔', color: 'from-violet-500 to-purple-600' }
  ]);

  // ✅ Enhanced Clear Search Event Listener
  useEffect(() => {
  ...
  const getFallbackBooks = () => {
    return [
      ...
      },
      {
        ...
        coverUrl: 'https://covers.openlibrary.org/b/id/1070634-M.jpg',
        publishYear: '1996',
        pages: '657',
        language: 'English',
        isbn: '9780262011532',
        category: 'Computer Science',
        rating: '4.9',
        description: 'A computer science textbook by Massachusetts Institute of Technology professors that teaches fundamental principles of computer programming.'
      },
      {
        id: 'fallback_6',
        ...
        rating: '4.4',
        description: 'Stewart\'s Calculus: Early Transcendentals is widely renowned for its mathematical precision and accuracy, clarity of exposition, and outstanding examples and problem sets.'
      },
      {
        id: 'fallback_7',
      ...
      },
      {
        ...
        coverUrl: 'https://covers.openlibrary.org/b/id/87654321-M.jpg',
        publishYear: '2016',
        pages: '1328',
        language: 'English',
        isbn: '9780134042282',
        category: 'Chemistry',
        rating: '4.3',
        description: 'All of Paula Bruice\'s extensive revisions to the Seventh Edition of Organic Chemistry follow a central guiding principle: support what modern students need in order to understand and retain what they learn in organic chemistry for successful futures in industry, research, and medicine.'
      }
    ];
  };
    ...
    const fetchBooksData = async () => {
      ...
      try {
        ...
        if (apiBooks.length > 0) {
          ...
          const fallbackBooks = getFallbackBooks();
          setBooks(fallbackBooks.slice(0, 6));
  ...
  const handleSearch = async (query) => {
    ...
    try {
      ...
      const allBooks = [...books, ...recommendedBooks, ...getFallbackBooks()];
      ...
      try {
        const apiResponse = await searchBooks(query, 12);
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="mb-6 sm:mb-8">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto font-medium leading-relaxed px-4">
              Explore millions of books from Open Library, research papers, and educational resources. 
